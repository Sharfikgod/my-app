  ...
  return (
    <div>
      ...
      <div className={styles.description}>
        ...
        <span className={styles.namesz}>Description1: {props.profile.lookingForAJobDescription}</span>
        <span className={styles.namesz}>Description2: {props.profile.contacts.twitter}</span>
